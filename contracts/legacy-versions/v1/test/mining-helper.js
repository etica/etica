  ...
  mineCoins(web3, contractData , minerEthAddress)
  {
      //may need a second solution_number !!
             ...
             var target = contractData.miningTarget;
              ...
              var digest =  web3.utils.soliditySha3( challenge_number , minerEthAddress, solution_number )


            //  console.log(web3.utils.hexToBytes('0x0'))
            var digestBytes32 = web3.utils.hexToBytes(digest)
            ...
            //  console.log('digestBigNumber',digestBigNumber.toString())
                    ...
                    console.log(minerEthAddress)
                     ...
                     console.log(solution_number)
                      console.log(challenge_number)
                        console.log(solution_number)
                    console.log('------')
                     console.log( web3.utils.bytesToHex(digestBytes32))
                 }
             ...
             if ( digestBigNumber.lt(miningTarget)  )
             {
               ...
               if(this.testMode){
                 ...
                 this.networkInterface.checkMiningSolution( minerEthAddress, solution_number , web3.utils.bytesToHex( digestBytes32 ),challenge_number,miningTarget,
                   function(result){
                ...
                this.submitNewMinedBlock( minerEthAddress, solution_number,   web3.utils.bytesToHex( digestBytes32 ) , challenge_number);
              }
             }
